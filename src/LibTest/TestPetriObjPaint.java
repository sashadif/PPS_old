...
public class TestPetriObjPaint {  //Результати співпадають з аналітичними обрахунками
     ...
     // метод для конструювання моделі масового обслуговування з 4 СМО 
      ...
      public static PetriObjModel getModel() throws ExceptionInvalidTimeDelay, ExceptionInvalidNetStructure{
          ...
          list.add(new PetriSim(NetLibraryOld.CreateNetGenerator(2.0)));
          list.add(new PetriSim(NetLibraryOld.CreateNetSMOwithoutQueue(1, 0.6,"First")));
          list.add(new PetriSim(NetLibraryOld.CreateNetSMOwithoutQueue(1, 0.3, "Second")));
          list.add(new PetriSim(NetLibraryOld.CreateNetSMOwithoutQueue(1, 0.4,"Third")));
          list.add(new PetriSim(NetLibraryOld.CreateNetSMOwithoutQueue(2, 0.1,"Forth")));
          list.add(new PetriSim(NetLibraryOld.CreateNetFork(0.15, 0.13, 0.3)));
      //перевірка зв'язків
