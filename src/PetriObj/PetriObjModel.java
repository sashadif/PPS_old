...
public class PetriObjModel implements Serializable {
    ...
    public void go(double timeModeling) {
       ...
       PetriSim.setTimeCurr(0); //11.03.2021 by Inna
        t = 0;
        double min;
...
//                }
                ...
                for (PetriSim e: listObj) {
                    if (e.getNumObj() == conflictObj.get(num).getNumObj()) {
                        if (isProtokolPrint == true) {
                            System.out.println(" time =   " + this.getCurrentTime() + "   Event '" + e.getEventMin().getName() 
                ...
                for (PetriSim e : listObj) {
                    if (min > 0) {
                        if(min<timeModeling)
                            ...
                            e.doStatistica((timeModeling - t) / timeModeling); 
                    }
                }
            }
